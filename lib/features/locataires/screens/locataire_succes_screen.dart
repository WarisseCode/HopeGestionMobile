...
/// Écran de confirmation de création d'un locataire / contact.
class LocataireSuccesScreen extends StatelessWidget {
  const LocataireSuccesScreen({
    super.key,
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Spacer(),
              // Cercle de succès vert HopeGestion
              Container(
                width: 88,
                height: 88,
              ...
              Text(
                'Le profil « $nomLocataire » ($typeProfile) a été créé avec succès.',
